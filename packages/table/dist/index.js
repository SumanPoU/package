...
function SelectGroup({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_radix_ui3.Select.Group, { "data-slot": "select-group", ...props });
}
...
function SelectTrigger({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    import_radix_ui3.Select.Trigger,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_radix_ui3.Select.Icon, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react2.ChevronDownIcon, { className: "size-4 opacity-50" }) })
      ]
    }
  );
}
function SelectContent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_radix_ui3.Select.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "span",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_radix_ui3.Select.ItemIndicator, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react2.CheckIcon, { className: "size-4" }) })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_radix_ui3.Select.ItemText, { children })
      ]
    }
  );
}
function SelectSeparator({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    import_radix_ui3.Select.Separator,
    {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { className: "text-sm text-muted-foreground", children: [
          "Showing ",
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "font-medium text-foreground", children: from }),
          "\u2013",
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "font-medium text-foreground", children: to }),
          " of",
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "font-medium text-foreground", children: totalItems })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-wrap items-center gap-2", children: [
          onPageSizeChange ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "text-sm text-muted-foreground", children: "Rows" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
              Select,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectTrigger, { size: "sm", "aria-label": "Rows per page", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectValue, {}) }),
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectContent, { children: pageSizeOptions.map((option) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectItem, { value: String(option), children: option }, option)) })
                ]
              }
            )
          ] }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Button,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react3.ChevronsLeftIcon, {})
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Button,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react3.ChevronLeftIcon, {})
              }
            ),
            visiblePages.map(
              (item, index) => item === "ellipsis" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "span",
                {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Button,
              {
                ...
                onClick: () => onPageChange(page + 1),
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react3.ChevronRightIcon, {})
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Button,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react3.ChevronsRightIcon, {})
              }
            )
          ] })
        ] })
...
function useTableSelection(options = {}) {
  ...
  const [uncontrolledSelectedIds, setUncontrolledSelectedIds] = (0, import_react.useState)(defaultSelectedIds);
  ...
  const setSelectedIds = (0, import_react.useCallback)(
    (next) => {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "div",
          {
            ...
            style: { maxHeight },
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Table, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                TableHeader,
                {
                  className: cn(
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(TableRow, { "data-state": "header", className: "hover:bg-transparent", children: [
                    selectable ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TableHead, { className: "w-10", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                      Checkbox,
                      {
                    ...
                    columns.map((column) => {
                      ...
                      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                        TableHead,
                        {
                          ...
                          children: column.sortable ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
                            "button",
                            {
                              type: "button",
                              ...
                              children: [
                                column.header,
                                direction === "asc" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react4.ArrowUpIcon, { className: "size-3.5", "aria-hidden": "true" }) : direction === "desc" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                                  import_lucide_react4.ArrowDownIcon,
                                  {
                                    className: "size-3.5",
                                    "aria-hidden": "true"
                                  }
                                ) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                                  import_lucide_react4.ArrowUpDownIcon,
                                  {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TableBody, { children: pageRows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TableRow, { className: "hover:bg-transparent", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                TableCell,
                {
                  colSpan,
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
                  TableRow,
                  {
                    ...
                    children: [
                      selectable ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TableCell, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                        Checkbox,
                        {
                          checked: isSelected,
