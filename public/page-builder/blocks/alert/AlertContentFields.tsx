...
export function AlertContentFields({
  block,
  activeLang,
  onChangeShared,
  onChangeI18n,
    ...
    <div className="space-y-3">
      <div className="space-y-1.5">
        <Label className="text-[11px] text-gray-400 uppercase tracking-wide">
          Variant <span className="ml-1 text-gray-300 normal-case font-normal">(shared)</span>
        </Label>
        <select
          value={block.props.variant || 'info'}
          onChange={(e) => onChangeShared('variant', e.target.value)}
      ...
      <div className="space-y-1.5">
        <div className="flex items-center">
          <Label className="text-[11px] text-gray-400 uppercase tracking-wide">Message Text</Label>
