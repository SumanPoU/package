...
export function CounterContentFields({
  block,
  activeLang,
  onChangeShared,
  onChangeI18n,
    ...
    <div className="space-y-3">
      <div className="space-y-1.5">
        <Label className="text-[11px] text-gray-400 uppercase tracking-wide">
          Target Number <span className="ml-1 text-gray-300 normal-case font-normal">(shared)</span>
        </Label>
        <Input
          type="number"
          value={block.props.targetNumber ?? ''}
          onChange={(e) => onChangeShared('targetNumber', e.target.value)}
