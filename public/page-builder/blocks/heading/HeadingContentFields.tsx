...
export function HeadingContentFields({
  block,
  activeLang,
  onChangeShared,
  onChangeI18n,
    ...
    <div className="space-y-3">
      <div className="space-y-1.5">
        <Label className="text-[11px] text-gray-400 uppercase tracking-wide">
          Heading Level <span className="ml-1 text-gray-300 normal-case font-normal">(shared)</span>
        </Label>
        <select
          value={block.props.level || '2'}
          onChange={(e) => onChangeShared('level', e.target.value)}
