...
export function IconBoxContentFields({
  block,
  activeLang,
  onChangeShared,
  onChangeI18n,
  ...
  return (
    <div className="space-y-3">
      <div className="space-y-1.5">
        ...
        <IconPicker
          value={block.props.iconName || 'Star'}
      ...
      <div className="space-y-1.5">
        <div className="flex items-center">
          <Label className="text-[11px] text-gray-400 uppercase tracking-wide">Description</Label>
          <LangCoverage block={block} propKey="description" />
        </div>
        <Textarea
          value={getVal('description', editingLang)}
          onChange={(e) => updateProp('description', e.target.value, editingLang)}
          rows={3}
