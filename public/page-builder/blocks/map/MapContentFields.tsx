...
export function MapContentFields({
  block,
  activeLang,
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center">
        ...
        <LangCoverage block={block} propKey="address" />
      </div>
      <Input
        value={getVal('address', editingLang)}
        onChange={(e) => updateProp('address', e.target.value, editingLang)}
