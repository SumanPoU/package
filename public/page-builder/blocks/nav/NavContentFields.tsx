...
export function NavContentFields({
  block,
  activeLang,
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center">
        ...
        <LangCoverage block={block} propKey="links" />
      </div>
      <Textarea
        value={getVal('links', editingLang)}
        onChange={(e) => updateProp('links', e.target.value, editingLang)}
        placeholder="Home, /\nAbout, /about"
        rows={4}
