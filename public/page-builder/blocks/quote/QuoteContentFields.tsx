    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center">
          <Label className="text-[11px] text-gray-400 uppercase tracking-wide">Quote Text</Label>
      ...
      <div className="space-y-1.5">
        <div className="flex items-center">
          ...
          <LangCoverage block={block} propKey="author" />
        </div>
        <Input
          value={getVal('author', editingLang)}
          onChange={(e) => updateProp('author', e.target.value, editingLang)}
