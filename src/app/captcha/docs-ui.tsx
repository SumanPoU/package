      ...
      <table className="w-full min-w-[40rem] border-collapse bg-card text-left text-sm">
        <thead>
          <tr className="border-b-[0.5px] border-border bg-card">
            <th className="bg-card px-3 py-2.5 text-[12px] font-medium text-primary">
              Prop
            </th>
            <th className="bg-card px-3 py-2.5 text-[12px] font-medium text-primary">
              Type
        ...
        <tbody className="bg-card">
          {rows.map((row) => (
            <tr
              key={row.name}
              className="border-b-[0.5px] border-border bg-card last:border-0"
            >
              <td className="bg-card px-3 py-2.5 align-top font-mono text-[12.5px] break-words text-accent">
                {row.name}
              </td>
              <td className="max-w-[14rem] bg-card px-3 py-2.5 align-top font-mono text-[11.5px] leading-snug break-all text-secondary">
                {row.type}
              </td>
