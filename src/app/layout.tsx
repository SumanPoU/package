...
export const metadata: Metadata = {
  ...
  title: {
    default: `${SITE_NAME} — React DataTable, Nepali UI & TypeScript packages`,
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: SITE_NAME,
    title: `${SITE_NAME} — React DataTable, Nepali UI & TypeScript packages`,
    description: SITE_DESCRIPTION,
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
        height: 630,
        alt: `${SITE_NAME} — React DataTable & Nepal-ready packages`,
      },
    ],
  },
  twitter: {
