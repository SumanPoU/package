...
export const DOC_NAV: NavItem[] = [
  ...
  { id: "playground-compare", label: "Gateway comparison", indent: true },
  ...
  { id: "responses-connectips", label: "connectIPS payloads", indent: true },
  ...
  { id: "example-connectips", label: "connectIPS form POST", indent: true },
  ...
  { id: "connectips", label: "connectIPS (NCHL)" },
  { id: "connectips-overview", label: "In plain words", indent: true },
  { id: "connectips-phases", label: "Each phase", indent: true },
  { id: "connectips-token", label: "TOKEN signing", indent: true },
  { id: "connectips-form", label: "Login form fields", indent: true },
  { id: "connectips-validate", label: "validatetxn", indent: true },
